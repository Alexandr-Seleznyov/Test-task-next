    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="frontend-navbar-collapse">
            <ul class="nav navbar-nav">
                @if (! Auth:: guest())
                    <li class="logined" id="li1">{{ link_to_route('frontend.index', 'Дерево') }}</li>
                    <li class="logined" id="li1">{{ link_to_route('frontend.user.list', 'Список') }}</li>
                    <li class="logined" id="li2">{{ link_to_route('frontend.user.positions', 'Должности') }}</li>
                @endif
            </ul>
